...
public class PracticaJava6b {
    ...
    private static final String MSG2 = "Inserta un mes (en numero)";
    private static final String MSG3 = "El mes tiene:";
    private static final String MSG4 = "dias";
    ...
    public static void main(String[] args) {
        ...
        switch (mes) {
            case 1:
                dia = 31;
                System.out.println(MSG3 + " " + dia + MSG4);
                break;
            case 2:
                if (año % CASO1 == 0) {
                    if (año % CASO2 == 0) {
